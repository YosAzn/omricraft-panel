...
export const DEFAULT_ADDONS = [
  ...
  { id: 'p27', name: 'MythicMounts', desc: 'חיות רכיבה מיוחדות! מאפשר לרכוב על אפיגאסט (Epigast), לשים לו הארנס (רתמה) עם כישוף Soul Speed שככל שרמתו גבוהה יותר, החיה טסה מהר יותר! (דורש MythicMobs)', requiresNote: 'תוסף בתשלום — העלאת קובץ JAR ידנית; דורש גם את MythicMobs', type: 'plugins', requires: ['p21'], downloads: '1.5M', rating: 4.8, reviews: 4200, paid: true, buyUrl: 'https://mythiccraft.io/index.php?resources/' },
  { id: 'p28', name: 'ItemsAdder', desc: 'הוספת אלפי חפצים, נשקים, רהיטים ובלוקים חדשים לשרת (כולל טקסטורות) בלי שאף שחקן יצטרך להוריד מודים (פלאגין בתשלום — מעלים ידנית; ProtocolLib הנדרש מותקן אוטומטית מ-GitHub)', requiresNote: 'תוסף בתשלום — העלאת קובץ JAR ידנית', type: 'plugins', requires: ['p37'], downloads: '4.5M', rating: 4.9, reviews: 18000, paid: true, buyUrl: 'https://itemsadder.devs.beer/' },
  ...
  { id: 'd2', name: 'Terralith', desc: 'משנה לחלוטין את יצירת העולם, ביומות והרים ללא בלוקים חדשים (datapack של worldgen — עובד רק על Vanilla/Fabric/Forge/NeoForge; שרתי Bukkit כמו Paper/Purpur/Folia מתעלמים מביומות worldgen של datapack, וצריך להחיל אותו על עולם חדש)', requiresNote: 'עובד רק על Vanilla/Fabric/Forge/NeoForge, ורק על עולם חדש', type: 'datapacks', installMethod: 'server', modrinthSlug: 'terralith', worldgenOverhaul: true, downloads: '4M', rating: 4.7, reviews: 5100 },
  ...
  { id: 'd6', name: 'Mini Blocks', desc: 'מאפשר להשיג גרסאות מיניאטוריות של בלוקים כראשים (datapack של function/loot — פועל על כל סוג שרת שתומך datapacks, כולל Paper)', requiresNote: 'פאק-קראפט — צריך לבנות את המתכונים בשולחן יצירה (שום דבר לא נופל לבד)', type: 'datapacks', installMethod: 'server', modrinthSlug: 'mini-blocks-datapack', downloads: '1.5M', rating: 4.6, reviews: 1200 },
  ...
  { id: 'd10', name: 'Player Head Drops', desc: 'שחקנים מפילים את הראש שלהם כשהם מתים מחיצים או שחקנים', requiresNote: 'הראש נופל רק כששחקן מת מחץ או משחקן אחר — לא ממוות רגיל (נפילה/לבה/מוב)', type: 'datapacks', installMethod: 'server', modrinthSlug: 'player-drops-head', downloads: '2.1M', rating: 4.6, reviews: 1700 },
  { id: 'd11', name: 'All Mob Heads', desc: 'כל המובים במשחק יכולים להפיל את הראש שלהם למטרות קישוט', requiresNote: 'חרב עם Looting — ראשים נופלים רק כששחקן הורג מפלצת עם Looting (בלי Looting לא ייפול ראש)', type: 'datapacks', installMethod: 'server', modrinthSlug: 'amh', downloads: '2.8M', rating: 4.7, reviews: 2500 },
  ...
  { id: 'd13', name: 'Tectonic', desc: 'שדרוג עולם דרמטי - הרים ענקיים, נהרות ועמקים עמוקים, בלי בלוקים חדשים (datapack של worldgen — עובד רק על Vanilla/Fabric/Forge/NeoForge; להחלה על עולם חדש)', requiresNote: 'עובד רק על Vanilla/Fabric/Forge/NeoForge, ורק על עולם חדש', type: 'datapacks', installMethod: 'server', modrinthSlug: 'tectonic', worldgenOverhaul: true, downloads: '1.5M', rating: 4.7, reviews: 2100 },
  { id: 'd14', name: 'Incendium', desc: 'שדרוג מלא לנדר (Nether) - ביומות, מבנים ובוסים חדשים מסוכנים (datapack של worldgen — עובד רק על Vanilla/Fabric/Forge/NeoForge; להחלה על עולם חדש)', requiresNote: 'עובד רק על Vanilla/Fabric/Forge/NeoForge, ורק על עולם חדש', type: 'datapacks', installMethod: 'server', modrinthSlug: 'incendium', worldgenOverhaul: true, downloads: '1.8M', rating: 4.8, reviews: 2400 },
  { id: 'd15', name: 'Nullscape', desc: 'הופך את העולם הסופי (End) לאזור אטמוספרי ומסתורי עם ביומות חדשות (datapack של worldgen — עובד רק על Vanilla/Fabric/Forge/NeoForge; להחלה על עולם חדש)', requiresNote: 'עובד רק על Vanilla/Fabric/Forge/NeoForge, ורק על עולם חדש', type: 'datapacks', installMethod: 'server', modrinthSlug: 'nullscape', worldgenOverhaul: true, downloads: '1.3M', rating: 4.7, reviews: 1600 },
